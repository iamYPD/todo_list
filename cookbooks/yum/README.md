...
yum_repository 'zenoss' do
  descriptiontion "Zenoss Stable repo"
...
yum_repository 'epel' do
  descriptiontion 'Extra Packages for Enterprise Linux'
...
- `descriptiontion` - Maps to the 'name' parameter in a repository .conf. Descriptive name for the repository channel. This directive must be specified.
