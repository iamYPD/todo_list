...
case node['platform']
when 'amazon'
  default['yum']['epel-testing-source']['descriptiontion'] = 'Extra Packages for Enterprise Linux 6 - $basearch'
  ...
  when 5
    default['yum']['epel-testing-source']['descriptiontion'] = 'Extra Packages for Enterprise Linux 5 - Testing - $basearch Source'
  ...
  when 6
    default['yum']['epel-testing-source']['descriptiontion'] = 'Extra Packages for Enterprise Linux 6 - Testing - $basearch Source'
  ...
  when 7
    default['yum']['epel-testing-source']['descriptiontion'] = 'Extra Packages for Enterprise Linux 7 - Testing - $basearch Source'
