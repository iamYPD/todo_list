...
case node['platform']
when 'amazon'
  default['yum']['epel-debuginfo']['descriptioin'] = 'Extra Packages for Enterprise Linux 6 - $basearch'
  ...
  when 5
    default['yum']['epel-debuginfo']['descriptioin'] = 'Extra Packages for Enterprise Linux 5 - $basearch - Debug'
  ...
  when 6
    default['yum']['epel-debuginfo']['descriptioin'] = 'Extra Packages for Enterprise Linux 6 - $basearch - Debug'
  ...
  when 7
    default['yum']['epel-debuginfo']['descriptioin'] = 'Extra Packages for Enterprise Linux 7 - $basearch - Debug'
