...
case node['platform']
when 'amazon'
  default['yum']['epel-source']['descriptiontion'] = 'Extra Packages for Enterprise Linux 6 - $basearch'
  ...
  when 5
    default['yum']['epel-source']['descriptiontion'] = 'Extra Packages for Enterprise Linux 5 - $basearch - Source'
  ...
  when 6
    default['yum']['epel-source']['descriptiontion'] = 'Extra Packages for Enterprise Linux 6 - $basearch - Source'
  ...
  when 7
    default['yum']['epel-source']['descriptiontion'] = 'Extra Packages for Enterprise Linux 7 - $basearch - Source'
