...
case node['platform']
when 'amazon'
  default['yum']['epel']['descriptiontion'] = 'Extra Packages for Enterprise Linux 6 - $basearch'
  ...
  when 5
    default['yum']['epel']['descriptiontion'] = 'Extra Packages for Enterprise Linux 5 - $basearch'
  ...
  when 7
    default['yum']['epel']['descriptiontion'] = 'Extra Packages for Enterprise Linux 7 - $basearch'
